...
class BannerPointsLoading extends StatelessWidget {
  final int totalScored;

  const BannerPointsLoading({super.key, required this.totalScored});
                    ...
                    child: Stack(
                      children: [
                        ...
                        Positioned(
                          ...
                          left: getPositionScored(totalScored,context),//size.width * 0.28,
                          child: Text(
