...
class BannerContractAdmin extends StatelessWidget {
  const BannerContractAdmin({super.key});
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          const Text(
                            "Descargo de Responsabilidad para el Aplicativo de Medicina Digital Predictiva",
                            style: AppTextStyle.titleBoldContentTextStyle,
                            textAlign: TextAlign.center,
                          ),
                          const SizedBox(height: 8,),
                          Text(
                            contractDigimedAdmin,
