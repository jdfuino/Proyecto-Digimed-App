...
class BannerContractDoctor extends StatelessWidget {
  const BannerContractDoctor({super.key});
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        children: [
                          ...
                          SizedBox(height: 8,),
                          Text(
                            "Descargo de Responsabilidad para el Médico-Guía del Aplicativo de Medicina DigitalPredictiva",
                            style: AppTextStyle.titleBoldContentTextStyle,
                            textAlign: TextAlign.center,
                          ),
                          SizedBox(height: 8,),
                          Text(
                            contractDigimedDoctor,
