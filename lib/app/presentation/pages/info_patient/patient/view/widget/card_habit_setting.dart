...
class CardHabitPatientSetting extends StatelessWidget {
  const CardHabitPatientSetting({super.key});
              ...
              ElevatedButton.icon(
                ...
                onPressed: () async {
                  ...
                  result.when(left: (failure) {
                    ...
                    await controller.refreshMePatient(
                        associatePatientPatients: const DataPatientStateLoading());
                    controller.state = controller.state
                        .copyWith(isSetting: false);
                  });
                },
              ),
            ],
