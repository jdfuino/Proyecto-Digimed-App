...
import 'package:digimed/app/presentation/pages/home/doctor/home/view/widget/list_item_patients_doctor.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ListPatientsDoctor extends StatelessWidget {
  const ListPatientsDoctor({super.key});

  @override
  Widget build(BuildContext context) {
    final HomeDoctorController controller = context.watch();
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      contentPadding: const EdgeInsets.fromLTRB(
                          20.0, 15.0, 20.0, 15.0),
                      prefixIcon: const Icon(DigimedIcon.search,size: 14,),
                  ...
                  Expanded(child: controller.state.associatePatients.when(
                      ...
                      if(list != null){
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListItemPatientDoctor(itemPatient: item,index: index);
                          },
                        );
                      }
                      return Container(
