...
import 'package:digimed/app/presentation/pages/home/admin/home_doctor/view/widget/list_item_patient.dart';
...
class ListPatients extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final HomeDoctorAdminController controller = context.watch();
                      ...
                      if(list != null && list.isNotEmpty){
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListItemPatient(itemPatient: item,index: index,);
                          },
                        );
                      }
                      return Container(
