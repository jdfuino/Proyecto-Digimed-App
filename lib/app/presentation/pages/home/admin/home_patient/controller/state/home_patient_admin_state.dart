...
part 'home_patient_admin_state.freezed.dart';

@freezed
class HomePatientAdminState with _$HomePatientAdminState {
  const factory HomePatientAdminState({
    ...
    @Default(IAFetchState.loaded()) IAFetchState iAFetchState,
    ...
    @Default(AssociateDoctorSpecialist.loading())
      AssociateDoctorSpecialist associateDoctorSpecialist
  }) = _HomePatientAdminState;
}

@freezed
class AssociateDoctorSpecialist with _$AssociateDoctorSpecialist {
  const factory AssociateDoctorSpecialist.loading() = AssociateDoctorSpecialistLoading;

  const factory AssociateDoctorSpecialist.failed(
      HttpRequestFailure failure,
      ) = AssociateDoctorSpecialistFailed;

  const factory AssociateDoctorSpecialist.loaded(
    List<DoctorSpecialists> list,
  ) = AssociateDoctorSpecialistLoaded;
}
...
@freezed
class IAFetchState with _$IAFetchState{
  const factory IAFetchState.loading() = IAFetchStateLoading;

  const factory IAFetchState.loaded() = IAFetchStateLoaded;
}
