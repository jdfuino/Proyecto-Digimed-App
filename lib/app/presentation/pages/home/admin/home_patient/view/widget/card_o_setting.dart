...
class CardOSetting extends StatelessWidget {
  const CardOSetting({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final _noteController = TextEditingController(
      text: controller.edit! ? controller.noteO : '',
    );
    return Container(
                ...
                return ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    if(_noteController.text.isNotEmpty){
                      ...
                      await controller.setNewNoteO(input);
                    }
                    controller.state =
                        controller.state.copyWith(isSettingDataO: false);
                  },
                );
              })
            ],
