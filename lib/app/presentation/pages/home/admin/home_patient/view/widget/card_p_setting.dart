...
class CardPSetting extends StatelessWidget {
  const CardPSetting({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final _noteController = TextEditingController(
      text: controller.edit! ? controller.noteP : '',
    );
    return Container(
                ...
                return ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    if(_noteController.text.isNotEmpty){
                      ...
                      await controller.setNewNoteP(input);
                    }
                    controller.state =
                        controller.state.copyWith(isSettingDataP: false);
                  },
                );
              })
            ],
