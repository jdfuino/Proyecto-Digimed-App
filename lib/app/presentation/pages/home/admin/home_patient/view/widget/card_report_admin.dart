...
class CardReportAdmin extends StatelessWidget {
  const CardReportAdmin({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: CardDigimed(
        child: Container(
          margin: const EdgeInsets.only(right: 8, left: 16, bottom: 8,top: 16),
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                height: size.height * 0.5, // Ajusta esta altura según necesites
                child: controller.state.reportFetchState.when(
                  loading: () =>
...
//         controller.createNewReport((message) {
//           showDialog(
//               context: context,
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  convertDate("2022-08-05T14:55:45.556"),
          ...
          ElevatedButton.icon(
            onPressed: () {
              controller.getReportBase64(reportID: item.reportID);
            },
            icon: const Icon(
