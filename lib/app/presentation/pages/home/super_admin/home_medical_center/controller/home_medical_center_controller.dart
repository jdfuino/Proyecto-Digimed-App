...
class HomeMedicalCenterController
    extends StateNotifier<HomeMedicalCenterState> {
  final AccountRepository accountRepository;
  final AuthenticationRepository authenticationRepository;
  final SessionController sessionController;
  final idMedicalCenter;

  HomeMedicalCenterController(super._state,
  ...
  Future<void> listMedicalCenterCoordinator(
    ...
    final result =
        await accountRepository.medicalCenterCoordinator(idMedicalCenter);
  ...
  Future<void> searchOnChanged(String text) async {
    ...
    state = state.copyWith(requestState: RequestState.loaded(listFiltrate));
  }
}
