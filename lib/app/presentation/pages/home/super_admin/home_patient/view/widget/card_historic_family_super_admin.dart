...
import 'package:digimed/app/presentation/pages/home/super_admin/home_patient/view/widget/card_family_data_super_admin.dart';
import 'package:digimed/app/presentation/pages/home/super_admin/home_patient/view/widget/card_family_setting_super_admin.dart';
    ...
    return Container(
      ...
      child: CardDigimed(
          child: controller.state.isSettingDataFamilyHistoric
              ? const CardFamilySettingSuperAdmin()
              : const CardFamilyDataSuperAdmin()
      ),
    );
  }
}
