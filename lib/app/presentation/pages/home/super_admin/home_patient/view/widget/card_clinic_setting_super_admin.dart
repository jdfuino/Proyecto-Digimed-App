...
class CardClinicSettingSuperAdmin extends StatelessWidget {
  const CardClinicSettingSuperAdmin({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            TextFormField(
              ...
              onTap: () async {
                DateTime? date =
                    DateTime.parse(controller.patients.user.birthday);
              ...
              decoration: InputDecoration(
                ...
                hintText: convertDate(controller.patients.user.birthday),
            ...
            IntlPhoneField(
              decoration: InputDecoration(
                filled: true,
                fillColor: AppColors.backgroundSearchColor,
                hintText: controller.patients.user.phoneNumber,
                hintStyle: AppTextStyle.hintTextStyle,
                contentPadding:
                    const EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                enabledBorder: OutlineInputBorder(
              ...
              initialCountryCode:
                  getIsoCodeFromDialCode(controller.patients.user.countryCode),
              ...
              onSaved: (phone) {
                if (phone != null) {
                  ...
                  if(phone.countryCode.isNotEmpty &&
                      phone.countryCode != controller.patients.user.countryCode){
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                filled: true,
                fillColor: AppColors.backgroundSearchColor,
                hintText: controller.patients.user.occupation,
                hintStyle: AppTextStyle.hintTextStyle,
                contentPadding:
                    const EdgeInsets.fromLTRB(20.0, 15.0, 20.0, 15.0),
                enabledBorder: OutlineInputBorder(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                filled: true,
                fillColor: AppColors.backgroundSearchColor,
                hintText: controller.patients.user.weight != null
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                filled: true,
                fillColor: AppColors.backgroundSearchColor,
                hintText: controller.patients.user.height != null
