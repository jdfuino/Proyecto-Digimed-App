...
class CardClinicSuperAdmin extends StatelessWidget {
  const CardClinicSuperAdmin({super.key});
      ...
      child: Column(
        children: [
                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      // HAbilidad de modificar el perfil cardiovascular del paciente por el admin
                      const Divider(color: AppColors.dividerColor),
                      Container(
                        margin: const EdgeInsets.only(right: 24, left: 24),
                        child: ButtonDigimed(
          ...
          ButtonDigimed(
              ...
              onTab: () {
                logger.i("Ver historial del paciente 3: ${controller.fatherPatient.patientID}");
