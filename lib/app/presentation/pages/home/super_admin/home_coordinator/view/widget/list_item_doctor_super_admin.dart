...
class ItemListDoctorSuperAdmin extends StatelessWidget {
  const ItemListDoctorSuperAdmin({Key? key, required this.itemDoctors, required this.index})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        pushNewPageSuperAdminToInfoDoctor(context, itemDoctors.user.id);
      },
      child: Container(
