...
import 'package:digimed/app/presentation/pages/home/super_admin/home_coordinator/view/widget/list_item_doctor_super_admin.dart';
import 'package:digimed/app/presentation/utils/utils.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class ListItemSuperAdmin extends StatefulWidget {
  const ListItemSuperAdmin({Key? key}) : super(key: key);

  @override
  State<ListItemSuperAdmin> createState() => _ListItemSuperAdminState();
}

class _ListItemSuperAdminState extends State<ListItemSuperAdmin> {
  @override
  Widget build(BuildContext context) {
    final SuperAdminHomeCoordinatorController controller = context.watch();
    final listDoctors = controller.state.listDoctors;
                  ...
                  return list.isNotEmpty
                      ? ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ItemListDoctorSuperAdmin(
                              itemDoctors: item,
                              index: index,
                            );
                          },
