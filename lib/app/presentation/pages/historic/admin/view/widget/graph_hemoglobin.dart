...
class GraphHemoglobin extends StatefulWidget {
  final String title;
  ...
  @override
  State<GraphHemoglobin> createState() => _GraphHemoglobinState();
}

class _GraphHemoglobinState extends State<GraphHemoglobin>
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Mensaje de estado de hemoglobina
            ...
            Row(
              children: [
                ...
                Flexible(
                  flex: 3,
                  child: controller.state.hemoglobinDataState.when(
    ...
    return PopupMenuButton<String>(
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              controller.valueSelectedHemoglobin,
  ...
  Widget _buildEnhancedChart(HistoricPatientsController controller) {
    ...
    if (_lastSelectedTime != controller.valueSelectedHemoglobin) {
      _lastSelectedTime = controller.valueSelectedHemoglobin;
                  ...
                  barTouchData: BarTouchData(
                    ...
                    touchTooltipData: BarTouchTooltipData(
                      ...
                      getTooltipItem: (group, groupIndex, rod, rodIndex) {
                        ...
                        String formattedValue = realValue.toStringAsFixed(1);

                        // Obtener el rango de fechas real desde el controlador
                        String timeRange = controller.getHemoglobinTimeRangeForPoint(groupIndex);
