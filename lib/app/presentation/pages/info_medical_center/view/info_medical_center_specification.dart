...
import 'package:digimed/app/presentation/pages/info_medical_center/view/widget/card_info.dart';
import 'package:digimed/app/presentation/utils/utils.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class InfoMedicalCenterSpecificationPage extends StatelessWidget {
  final int medicalCenterId;
  final MedicalCenter medicalCenter;

  const InfoMedicalCenterSpecificationPage({
    Key? key,
              ...
              children: [
                ...
                Container(
                  ...
                  child: ButtonDigimed(
                    ...
                    onTab: () {
                      pushNewPageInfoMedicalCenter(
                          context, medicalCenterId, medicalCenter);
                    },
                  ),
                ),
              ],
